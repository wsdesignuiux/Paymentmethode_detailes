package e.wolfsoft1.paymentmethode_detailes;
...
public class Paymentmethode_detailesActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_paymentmethode_detailes);
